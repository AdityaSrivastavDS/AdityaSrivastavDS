...
<img src="https://github.com/AdityaSrivastavDS/AdityaSrivastavDS/blob/main/resources/prima.png" alt="Waving Robot GIF" align="right" width="500" style="float: right; margin-left: 20px; margin-top: 20px;">
